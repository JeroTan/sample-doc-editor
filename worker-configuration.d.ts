/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77d02f260ff6d36d7e04876edb6d5be6)
// Runtime types generated with workerd@1.20260630.1 2026-04-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	STORAGE: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_NAME: "Doc-Me-In";
	SECRET_ENVIRONMENT_STATUS: "production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "SECRET_ENVIRONMENT_STATUS" | "APP_SECRET_KEY">> {}
}
